 ...
 */
class EDFConstants
{//define the constant as the length of each record of header information. 
        private EDFConstants() {}

        static final Charset CHARSET = Charset.forName("ASCII");//���߼������ASCII���ֵ�������Ϊ���룬http://blog.csdn.net/u010276761/article/details/52692962
